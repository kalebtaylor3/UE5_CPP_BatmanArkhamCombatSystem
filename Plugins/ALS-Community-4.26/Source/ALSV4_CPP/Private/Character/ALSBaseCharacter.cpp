...
void AALSBaseCharacter::BeginPlay()
{
	...
	//CombatSystem = Cast<UCombatSystem>(GetComponentByClass(UCombatSystem::StaticClass()));
...
bool AALSBaseCharacter::CanSprint() const
{
	...
	if (!bHasMovementInput
		...
		|| RotationMode == EALSRotationMode::Aiming)
	{
		return false;
	}
...
void AALSBaseCharacter::CounterAction_Implementation(bool bValue)
{
	if (bValue)
	{
